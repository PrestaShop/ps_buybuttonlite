...
class Ps_BuybuttonLite extends Module
{
    public function __construct()
    {
        ...
        $this->description = $this->trans('Increase your conversion rate and boost your sales, generate links and add them to your content so that visitors can easily proceed to checkout', [], 'Modules.Buybuttonlite.Admin');
    ...
    public function getContent()
    {
        ...
        $confTranslations = [
            'selectProduct' => $this->trans('Select a product', [], 'Modules.Buybuttonlite.Admin'),
            'searchProduct' => $this->trans('Search for a product', [], 'Admin.Orderscustomers.Feature'),
            'action' => $this->trans('Action', [], 'Admin.Global'),
            'sharableLink' => $this->trans('Get generated link', [], 'Modules.Buybuttonlite.Admin'),
            ...
            'alertCustomizableProduct' => $this->trans('The selected product is customizable, if it is added to cart through that shareable link, it won\'t get any customization. We recommend to share product page link instead.', [], 'Modules.Buybuttonlite.Admin'),
        ];

        $bannerPromoTranslations = [
            'copyToClipboard' => $this->trans('Copy to clipboard', [], 'Admin.Global'),
            'discover' => $this->trans('Discover', [], 'Admin.Modules.Feature'),
            'screenshots' => $this->trans('Screenshots', [], 'Admin.Global'),
